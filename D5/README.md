...
A RESTful API backend built with Express.js and Mongoose for managing roommate communications and tasks with full CRUD operations.

## Features

- ✅ Complete CRUD operations for roommate messages and announcements
...
Backend Example/
├── controllers/
│   └── messageController.js    # Business logic for roommate message operations
├── models/
│   └── Message.js             # Mongoose schema for roommate messages
├── routes/
...
**Create a rent reminder message:**
```bash
...
**Update a chore completion message:**
```bash
